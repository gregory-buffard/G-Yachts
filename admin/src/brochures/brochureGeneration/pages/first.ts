...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./css/brochure.css">
</head>

<body class="bg-cover bg-center">
    <div class="w-screen h-screen flex flex-col justify-center items-center py-12 px-28 bg-black/25" id="bg" >
        <div class="border-t-2 border-x-2 border-white w-full h-full flex flex-col items-center justify-between">
            <div class="flex flex-col items-center">
                <h1 class="text-white text-8xl text-center font-slick py-12 px-20 upper drop-shadow-2xl">${
                  doc.name
                }</h1>
                <span class="text-white text-4xl text-center font-classic px-20 drop-shadow-2xl">
