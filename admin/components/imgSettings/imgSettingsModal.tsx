...
const ImgSettingsModal = ({
  ...
  return (
    <Modal className={"h-[80%]"} size={"4xl"} isOpen={isOpen} onClose={onClose}>
      <ModalContent>
        <ModalHeader>
          ...
          >
            <div
              className={
                "w-full mx-5 h-fit flex justify-around items-center flex-row"
              }
            >
        ...
        <ModalBody className={"flex flex-col "}>
          <ScrollShadow
            className={"w-full gap-5 h-[70%] flex flex-wrap flex-row"}
          >
            {images.length > 0 &&
                ...
                return (
                  <div key={i} className={"relative w-[150px] group h-[150px]"}>
                    <Image
                      ...
                      alt={`image`}
                      className={
                        "w-[150px] h-[150px] object-center object-cover"
                      }
                    />
                    <div
                    ...
                    <div
                      className={
                        "w-[150px] z-20 h-[150px] hidden rounded-xl group-hover:flex bg-black/40 absolute top-0"
                      }
                    >
                      <div
                        className={
                          "w-full h-30% self-center flex flex-row justify-around"
                        }
                      >
                        <Button
                          variant={"light"}
                            ...
                            remove(data._id, i).then(() => {
                              setImages((currentItems: any) => {
                                return currentItems.filter(
                                  (item: string, index: number) => i !== index,
                                );
                              });
                            });
                          }}
