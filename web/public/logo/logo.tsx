    ...
    >
      <g id="Black" transform="translate(-751.816 -306.891)">
        ...
        <g id="g26" transform="translate(1069.384 369.018)">
          <path id="path28" d="M0,0H-17.015L-23.48,7.479H-6.425Z" />
        </g>
        <g id="g30" transform="translate(1108.117 381.471)">
          <path id="path32" d="M0,0H-66.295l-8.337,9.591H-8.277Z" />
        </g>
        <g id="g34" transform="translate(1027.107 398.783)">
          <path id="path36" d="M0,0-12.048,14.081H144.176L156.149,0Z" />
        </g>
        <g id="g38" transform="translate(1009.292 421.83)">
          <path id="path40" d="M0,0-35.244,45.688H263.089L301.913,0Z" />
        </g>
        <g id="g42" transform="translate(1008.489 456.608)">
          <path id="path44" d="M0,0V-18.643H2.284V-2.5H16.813V0Z" />
        </g>
        ...
        <g id="g62" transform="translate(1124.1 447.815)">
          <path
            id="path64"
            d="M0,0V8.793H-2.287V0l-8.837-9.843h3.173l6.805,7.531L5.641-9.843H8.864Z"
          />
        </g>
        <g id="g66" transform="translate(1152.959 447.815)">
          <path
            id="path68"
            d="M0,0V8.793H-2.284V0l-8.841-9.843h3.177l6.807,7.531L5.641-9.843H8.864Z"
          />
        </g>
        ...
        <g id="g78" transform="translate(1223.019 456.608)">
          <path
            id="path80"
            d="M0,0V-8.04H-14.309V0h-2.284V-18.643h2.284v8.068H0v-8.068H2.287V0Z"
          />
        </g>
        <g id="g82" transform="translate(1238.278 440.506)">
          <path id="path84" d="M0,0V16.1H-2.289V0h-8.3V-2.535H8.291V0Z" />
        </g>
