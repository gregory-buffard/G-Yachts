...
const Navigation = ({
  ...
  return (
    <section
      className={"absolute w-screen h-screen flex justify-start items-center"}
      onClick={() => {
        props.fadeIn(false);
        setTimeout(() => props.open(false), 500);
      }}
    >
      <nav
        className={`h-full w-[32vw] px-[2vw] bg-rock-100 text-navy flex justify-start items-start flex-col ${props.className} transition-transform duration-400 ease-in-out`}
      >
        <div className={"w-full flex justify-between items-center my-[2vh]"}>
          <button
            type={"button"}
            onClick={() => {
              props.fadeIn(false);
          ...
          >
            <svg
              ...
              viewBox="0 0 64 64"
              className={
                "size-[1.5vw] hover:rotate-90 transition-transform duration-200 ease-in-out"
              }
            >
        ...
        <div
          className={
            "w-full flex flex-col justify-start items-start my-[4vh] gap-[1vh]"
          }
        >
          <a
          ...
          <div className={"flex justify-start items-baseline fill-navy"}>
            <a
              href={
        ...
        <div className={"flex flex-col justify-start items-start"}>
          <Image
            src={logo}
            alt={"G–Yachts logo"}
            className={"w-[8vw] my-[2vh]"}
          />
          <div
            className={
              "flex justify-start items-center text-navy text-xs font-classic font-normal uppercase gap-[1vw]"
            }
          >
            <a
            ...
            >
              <svg
                ...
                y="0px"
                viewBox="0 0 64 64"
                className={"size-[1.5vw] fill-navy"}
              >
...
const Menu = () => {
  const [opened, setOpened] = useState<boolean>(false),
    [fadeIn, setFadeIn] = useState<boolean>(false);
    ...
    <>
      <Navigation
        props={{
          open: setOpened,
          fadeIn: setFadeIn,
          className: `${fadeIn ? "translate-x-0" : "-translate-x-full"}`,
        }}
      />
      <button
        onClick={() => {
