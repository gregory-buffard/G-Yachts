    ...
    return (
        <div className={"flex justify-center items-center"}>
            <button
                ...
                style={{
                    backgroundImage: `url(${process.env.NEXT_PUBLIC_API}/images/charters/${params.id}/${charter.photos.gallery[index]})`,
                }}
            />
        </div>
    );
                ...
                <div className="flex justify-start items-center w-full md:h-[64vh]">
                    {slides.map((index) => (
                        <Image
                            ...
                            width={500}
                            height={500}
                            src={`${process.env.NEXT_PUBLIC_API}/images/charters/${params.id}/${index}`}
                            alt={""}
        ...
        <AnimatePresence mode={"sync"}>
            {view === "gallery" && current === null && (
                ...
                >
                    ...
                    >
                        {charter.photos.gallery.map((photo, i) => (
                            <Image
                                key={photo}
                                onClick={() => setCurrent(i)}
                                width={500}
                                height={500}
                                src={`${process.env.NEXT_PUBLIC_API}/images/charters/${params.id}/${photo}`}
                                alt={charter.name}
                                className={
