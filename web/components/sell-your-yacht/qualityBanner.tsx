  ...
  return (
    <div className="w-full flex flex-col lg:flex-row h-full lg:h-screen">
      <div className="lg:w-1/2 flex flex-col justify-center bg-navy py-48 px-16 lg:relative">
        <h1 className="text-4xl lg:text-8xl font-bold text-white z-[2] overflow-x-visible w-[70vw] drop-shadow-md">
          {t("title")}
        </h1>
        ...
        <Image
          alt="Yacht"
          src={yacht}
          className="lg:absolute pt-20 lg:pt-0 lg:left-0 lg:top-50 lg:translate-x-[40vw] lg:z-[1] lg:w-[60vw] lg:h-auto"
        />
      </div>
    </div>
  );
