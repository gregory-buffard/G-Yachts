...
export const Input = ({
    ...
    return (
        <div className={"w-full flex flex-col justify-start items-start text-base tracking-wider"}>
...
const Inquiry = ({ props }: { props: { label: string; value: string } }) => {
    ...
    return (
        <div className={"flex justify-start items-baseline lg:gap-[0.5vw] gap-[2vw]"}>
            <input
                disabled={pending}
                id={props.value}
                type={"checkbox"}
...
const Contact = () => {
    ...
    return (
        <motion.section
            ...
            className={
                "fixed lg:bottom-0 lg:top-auto top-0 left-0 z-20 bg-rock-100 lg:h-[86vh] h-[100dvh] overflow-y-auto w-full flex flex-col justify-start items-center lg:px-[2vw] px-[4vw] py-[4vh] lg:gap-[2vh] gap-[4vh]"
            }
            ...
            <div
                ...
                <div
                    ...
                    <div className={"h-full flex flex-col justify-start items-start gap-[2vh]"}>
                ...
                {sent ? (
                    <motion.div
                        ...
                        <h1
                            ...
                            {t.rich("form.sent", {
                                classic: (chunk) => <span className={"font-classic"}>{chunk}</span>,
                            })}
                        </h1>
                        <p
